Feature: Register New User
  ...
  @Tamara @positive #RegisterNewUser_001
...
#    And Post create new user with valid data json schema validator
  ...
  @Tamara @negative #RegisterNewUser_002
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewUser_009
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewUser_010
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewUser_011
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative  #RegisterNewUser_012
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewUser_013
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewUser_014
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewUser_015
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewUser_016
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewUser_017
