Feature: Register New Class
  ...
  @Tamara @positive #RegisterNewClass_001
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewClass_002
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewClass_003
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewClass_004
...
#    And Post create new user json schema validator
  ...
  @Tamara @negative #RegisterNewClass_005
